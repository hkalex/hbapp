          ...
          <div className="navbar-header">
            <a href="#/" className="navbar-brand">
              <div className="brand-logo">
                <img src="/images/logo.png" alt="App Logo" className="img-responsive" />
              </div>
              <div className="brand-logo-collapsed">
                <img src="/images/logo-single.png" alt="App Logo" className="img-responsive" />
              </div>
            </a>
          </div>
          { /* END navbar header */}
          ...
          <div className="nav-wrapper">
            ...
            <ul className="nav navbar-nav navbar-right">
              ...
              <NavDropdown noCaret eventKey={3} title={ddAlertTitle} id="basic-nav-dropdown" >
                <MenuItem onClick={this.LogIn.bind(this)} className="animated flipInX" eventKey={3.1}>Login</MenuItem>
                ...
                <MenuItem divider />
                <MenuItem onClick={this.LogOut.bind(this)} className="animated flipInX" eventKey={3.3}>Logout</MenuItem>
              </NavDropdown>
              { /* END Alert menu */}
