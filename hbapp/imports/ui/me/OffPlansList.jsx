...
export default class OffPlansList extends Component {
  ...
  // 我的二手楼花
  onMyOffPlan() {
    this.props.router.push('/me/offplan_lists/item')
  }
  // 委托发布
  onReleasing() {
  ...
  render() {
    ...
    container = <div>
      <RaisedButton className="OLRB" label="我的列表"
        ...
        onClick={this.onMyOffPlan.bind(this)}
      ...
      <RaisedButton className="OLRB OLRBAgent" label="委托发布"
        {...this.page.style("OLRB", "OLRBAgent") }
        onClick={this.onReleasing.bind(this)}
        icon={<i className="fa fa-home OLRBIcon" {...this.page.style("OLRBIcon") } />} >
        <i className="fa fa-chevron-right OLRBringht" {...this.page.style("OLRBringht") }></i>
      </RaisedButton>
    </div>
    ...
    return (
      <div>
        <div>
          <AppBar className="appBar" title="我的二手楼花"
