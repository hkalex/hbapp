...
export default class OrderListItem extends Component {
  ...
  render() {
    ...
    const price = this.props.project ? Math.ceil(this.props.project.price.amount / 10000) : null;
    const topTags = this.props.project ? this.props.project.projectTags : null;
              ...
              <div className="MFLIdivContent" {...this.page.style("MFLIdivContent") } >
                <div className="MFLIinnerDiv" {...this.page.style("MFLIinnerDiv") } >
                  <p className="MFLIPrice" {...this.page.style("MFLIPrice") } >
                    <i className="MFLIIcon" {...this.page.style("MFLIIcon") } >￥</i>{price} </p>
